...
class UsersURLTests(TestCase):
    ...
    def test_urls_response_guest(self):
        ...
        url_status = {
            ...
            reverse(
                ...
                kwargs={"uidb64": "NA", "token": "5u2-61df9f91c57dffda7348"},
            ): HTTPStatus.OK,
    ...
    def test_urls_response_guest_redirect(self):
        ...
        url_status = {
            reverse("users:password_change_form"): reverse("users:login")
            + "?next="
            + reverse("users:password_change_form"),
            reverse("users:password_change_done"): reverse("users:login")
            + "?next="
